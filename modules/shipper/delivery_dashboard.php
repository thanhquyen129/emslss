            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <?php while($row = $orders->fetch_assoc()): ?>
                    ...
                    <tr>
                        <td>
                            <strong>
                                <a href="/modules/admin/admin_order_detail.php?id=<?= intval($row['id']) ?>">
                        ...
                        <td class="d-flex gap-1">
                            <a href="delivery_detail.php?id=<?= intval($row['id']) ?>" class="btn btn-sm btn-info">
                                Chi tiết
                            </a>
                            <?php if (in_array($row['status'], ['assigned_delivery', 'in_transit', 'failed'], true)): ?>
                            <a href="delivery_complete.php?id=<?= intval($row['id']) ?>" class="btn btn-sm btn-success">
                                Giao hàng
                            </a>
                            <?php endif; ?>
                        </td>
