...
<div class="container py-3">
    ...
    <div class="box">
        ...
        <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
                <div class="header-code"><?= htmlspecialchars($order['ems_code']) ?></div>
    ...
    <div class="d-grid gap-2 pb-4">
        <a href="pickup_scan.php?id=<?= $order['id'] ?>" class="btn btn-primary btn-lg btn-action">
            📷 Pickup ngay
        </a>

        <a href="pickup_dashboard.php" class="btn btn-outline-secondary btn-action">
            ← Quay lại dashboard
        </a>
    </div>
